...
#                           group.send(inter_group)
                        ...
                        if "1200" in dataS.hex() [0:4] and  b"/go" in dataS:
                        ...
                        if "1200" in dataS.hex() [0:4] and  b"/lag2" in dataS:
                            
                    
                                
                                response = "051500000020e865c5a3629aa2e8cae996eb5a3a212f5dbaf53f73715718738a068a8f678a05" 
                                responseo = "051500000020e865c5a3629aa2e8cae996eb5a3a212f5dbaf53f73715718738a068a8f678a05" 
                            
                                for i in range(500):
                                    
                                    group.send(bytes.fromhex(responseo))
                            
                        if "1200" in dataS.hex() [0:4] and  b"/lag1" in dataS:
                                   
                                response = "05150000001088dbc8a7945f34a503f4c10143def714" 
                                responseo = "0515000000102e0c839ca433ec43f2907b96476e1441" 
                        ...
                        if '0315' in dataC.hex()[0:4] and port == 39698  and len(dataC.hex()) > 750 and lvl == True  :
